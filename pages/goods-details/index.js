...
Page({
  ...
  async getGoodsDetailAndKanjieInfo(goodsId) {
    ...
    console.log(goodsDetailRes.data.goodsName+"goodsDetailRes.data")
    console.log(goodsDetailRes.status + "goodsDetailRes.status")
    const goodsKanjiaSetRes = null
      // await WXAPI.kanjiaSet(goodsId)
    if (goodsDetailRes.status == 200) {
      var selectSizeTemp = "";
      if (goodsDetailRes.data.properties) {
        ...
        that.setData({
          ...
          selectSizePrice: goodsDetailRes.data.hyPrice,
          totalScoreToPay: goodsDetailRes.data.price
        });
      }
      ...
      let _data = {
        ...
        selectSizePrice: goodsDetailRes.data.hyPrice,
        totalScoreToPay: goodsDetailRes.data.price,
        buyNumMax: goodsDetailRes.data.inventory,
        itemName: goodsDetailRes.data.itemName,
        buyNumber: (goodsDetailRes.data.inventory > 0) ? 1 : 0,
  ...
  //     }
      that.setData(_data);
      WxParse.wxParse('article', 'html', goodsDetailRes.data.description, that, 5);
    }
  },
  goShopCar: function() {
    wx.reLaunch({
  ...
  tobuy: function() {
    this.setData({
      shopType: "tobuy",
      selectSizePrice: this.data.goodsDetail.hyPrice
    });
    this.bindGuiGeTap();
  },
  ...
  bulidShopCarInfo: function() {
    ...
    shopCarMap.pic = this.data.goodsDetail.image;
    shopCarMap.name = this.data.goodsDetail.goodsName;
    shopCarMap.label=this.data.goodsDetail.itemName; //规格尺寸 
    shopCarMap.propertyChildIds = null;//
    // shopCarMap.label = this.data.propertyChildNames;//this.data.propertyChildNames
    shopCarMap.price = this.data.selectSizePrice;
    shopCarMap.score = this.data.totalScoreToPay;
    shopCarMap.left = "";
    shopCarMap.active = true;
    shopCarMap.number = this.data.buyNumber;
    shopCarMap.logisticsType = null;
    shopCarMap.logistics = null;
    shopCarMap.weight = null;
