  ...
  jiaBtnTap: function(e) {
    ...
    if (index !== "" && index != null) {
      ...
      WXAPI.goodsDetail(carShopBean.goodsId).then(function(res) {
        carShopBeanStores = res.data.inventory;
        console.log(carShopBeanStores +"/carShopBeanStores")
        console.log(list[parseInt(index)].number +"/list[parseInt(index)].number")
      ...
      if (!carShopBean.propertyChildIds || carShopBean.propertyChildIds == "") {
        WXAPI.goodsDetail(carShopBean.goodsId).then(function(res) {
          ...
          if (res.data.stores < carShopBean.number) {
            wx.showModal({
              title: '提示',
              content: res.data.goodsName + ' 库存不足，请重新购买',
              showCancel: false
            })
            isFail = true;
            wx.hideLoading();
          ...
          if (res.data.hyPrice != carShopBean.price) {
            wx.showModal({
              title: '提示',
              content: res.data.goodsName + ' 价格有调整，请重新购买',
              showCancel: false
            })
            isFail = true;
            wx.hideLoading();
